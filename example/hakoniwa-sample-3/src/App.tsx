  ...
  const commands: Record<string, CommandAction> = {
    ...
    help: async function* () {
      ...
      yield {
        ...
        log: {
          type: "output",
          text: "  preset <name>   - Change preset (emerald, matrix, dracula, amber, cyberpunk, light)",
        },
      };
      yield {
        type: "log",
        log: {
          type: "output",
          text: "  deploy          - Simulate an async task with progress bar",
        },
      };
      yield {
        type: "log",
      ...
      yield {
        ...
        log: {
          type: "success",
          text: "[SUCCESS] Command menu rendered successfully.",
        },
      };
    },
    ...
    preset: async function* (args: string[]) {
      ...
      if (TERMINAL_PRESETS[targetPreset]) {
        ...
        yield {
          ...
          log: {
            type: "success",
            text: `Preset successfully changed to "${targetPreset}".`,
          },
        };
      } else {
        yield {
    ...
    deploy: async function* () {
      ...
      yield {
        ...
        log: {
          type: "success",
          text: "🚀 Deployment finished with status 200 OK!",
        },
      };
    },
  };
        ...
        <div style={controlGroupStyle}>
          ...
          <label style={labelStyle}>
            ...
            <select
              value={currentPreset}
              onChange={(e) =>
                setCurrentPreset(e.target.value as TerminalPreset)
              }
              style={selectStyle}
            >
